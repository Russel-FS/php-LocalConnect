    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 sm:gap-6 mb-8 sm:mb-12 lg:mb-16">
            <div class="flex items-center gap-4 sm:gap-6">
                <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-primary-700 tracking-tight">Mis Negocios</h1>
        ...
        @if(session('success'))
        <div class="mb-6 sm:mb-8 p-4 sm:p-6 bg-secondary-100 border border-secondary-200 text-secondary-800 rounded-2xl shadow-sm">
            {{ session('success') }}
        </div>
        @endif
        ...
        @if($negocios->isEmpty())
        <div class="text-center py-16 sm:py-20 lg:py-24 bg-white/80 backdrop-blur-sm rounded-3xl border border-primary-100/50 shadow-sm">
            <div class="w-20 h-20 sm:w-24 sm:h-24 lg:w-32 lg:h-32 bg-primary-100 rounded-3xl flex items-center justify-center mx-auto mb-6 sm:mb-8">
                <svg class="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 text-primary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                </svg>
            </div>
            <h3 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary-700 mb-4 sm:mb-6">Aún no tienes negocios</h3>
            <p class="text-base sm:text-lg lg:text-xl text-primary-500 max-w-2xl mx-auto leading-relaxed mb-8 sm:mb-10">¿Listo para empezar? Registra tu primer negocio para que el mundo lo conozca.</p>
