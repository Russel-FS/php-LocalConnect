            ...
            <div class="bg-white rounded-2xl shadow p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-primary-700">{{ $contactos->where('tipo_contacto', 'telefono')->first()->valor_contacto }}</span>
                    </div>
                    @endif
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-primary-700">{{ $contactos->where('tipo_contacto', 'whatsapp')->first()->valor_contacto }}</span>
                    </div>
                    @endif
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-primary-700">{{ $contactos->where('tipo_contacto', 'facebook')->first()->valor_contacto }}</span>
                    </div>
                    @endif
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-primary-700">{{ $contactos->where('tipo_contacto', 'instagram')->first()->valor_contacto }}</span>
                    </div>
                    @endif
