    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 sm:gap-6 mb-8 sm:mb-10">
                <div>
                    ...
                    <p class="text-lg sm:text-xl text-primary-600 font-medium">
                        Buscando: <span class="font-semibold text-secondary-600 bg-secondary-100/80 backdrop-blur-sm px-3 py-1 rounded-full border border-secondary-200">"{{ request('q') }}"</span>
                    </p>
                    @endif
                </div>
                <span class="inline-flex items-center px-4 py-2 rounded-full text-sm sm:text-base font-semibold bg-white/80 backdrop-blur-sm border border-primary-200/50 text-primary-700 shadow-sm">
            ...
            <form action="{{ route('negocios.buscar') }}" method="GET" id="filtros-form" class="space-y-6">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <div class="flex gap-3">
                        <button type="submit" class="flex items-center gap-2.5 px-6 py-3 bg-gradient-to-r from-primary-800 to-primary-700 hover:from-primary-700 hover:to-primary-600 text-white rounded-full font-medium transition-all duration-300 shadow-sm hover:shadow-md">
        ...
        <div class="w-full">
            ...
            <div class="text-center py-20 sm:py-24 bg-white/90 backdrop-blur-md rounded-3xl border border-primary-200/60 shadow-sm">
                ...
                <a href="{{ route('negocios.buscar') }}" class="inline-flex items-center gap-3 px-8 py-4 rounded-full font-medium bg-gradient-to-r from-primary-800 to-primary-700 text-white shadow-sm hover:from-primary-700 hover:to-primary-600 transition-all duration-300">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                ...
                <div class="group bg-white/90 backdrop-blur-md rounded-2xl border border-primary-200/60 shadow-sm hover:shadow-lg hover:border-primary-300/80 transition-all duration-300 overflow-hidden hover:-translate-y-1">
                    ...
                    <div class="p-5">
                        ...
                        <div class="mb-4">
                            <h3 class="text-xl font-bold text-primary-800 tracking-tight mb-2 truncate group-hover:text-primary-700 transition-colors duration-300" title="{{ $negocio->nombre_negocio }}">
                        ...
                        <div class="flex items-center text-sm text-primary-600 mb-3">
                            <div class="w-6 h-6 bg-gradient-to-br from-primary-100 to-primary-200 rounded-full flex items-center justify-center mr-2 flex-shrink-0">
                        ...
                        <div class="mb-3">
                            <div class="flex flex-wrap gap-1.5">
                                ...
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-primary-100/80 backdrop-blur-sm text-primary-700 border border-primary-200/60">
                        ...
                        <div class="mb-3">
                            <div class="flex flex-wrap gap-1.5">
                                ...
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-secondary-100/80 backdrop-blur-sm text-secondary-700 border border-secondary-200/60">
                    ...
                    <!-- Footer con acción -->
                    <div class="px-5 pb-5">
                        <a href="{{ route('negocios.mostrar', $negocio->id_negocio) }}" class="w-full flex items-center justify-between p-3 bg-gradient-to-r from-primary-50/80 to-primary-100/60 backdrop-blur-sm hover:from-primary-100 hover:to-primary-200 rounded-xl transition-all duration-300 group-hover:shadow-sm border border-primary-200/30">
                            <span class="text-sm font-medium text-primary-700 group-hover:text-primary-800 transition-colors duration-300">
                                Ver detalles completos
                            </span>
                            <div class="w-8 h-8 bg-gradient-to-br from-primary-200 to-primary-300 rounded-full flex items-center justify-center group-hover:from-primary-300 group-hover:to-primary-400 transition-all duration-300">
