...
@section('content')
<div class="min-h-screen bg-primary-50 py-8 sm:py-12 lg:py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 sm:gap-6 mb-8 sm:mb-10">
                <div>
                    ...
                    <p class="text-lg sm:text-xl text-primary-600 font-medium">
                        Buscando: <span class="font-semibold text-secondary-600 bg-secondary-100 px-3 py-1 rounded-full">"{{ request('q') }}"</span>
                    </p>
                    @endif
                </div>
                <span class="inline-flex items-center px-4 py-2 rounded-full text-sm sm:text-base font-semibold bg-white border border-primary-200 text-primary-700 shadow-sm">
            ...
            <form action="{{ route('negocios.buscar') }}" method="GET" id="filtros-form" class="space-y-6">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <div class="relative group">
                        <button type="button" class="flex items-center gap-3 px-5 py-3 bg-white border border-primary-200 rounded-full shadow-sm hover:bg-primary-50 hover:border-primary-400 transition-all duration-200 text-primary-700 font-medium">
                        ...
                        <div class="absolute top-full left-0 mt-2 w-72 bg-white border border-primary-200 rounded-2xl shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
        ...
        <div class="w-full">
            @if($negocios->isEmpty())
            <div class="text-center py-20 sm:py-24 bg-white rounded-3xl border border-primary-200 shadow-sm">
