    ...
    <div class="w-full max-w-2xl bg-white rounded-2xl shadow-xl p-10 relative overflow-hidden">
        ...
        <div id="paso-1">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" class="w-full pl-11 pr-4 py-3 rounded-lg border border-gray-200 focus:border-primary-600 focus:ring-2 focus:ring-primary-100 outline-none transition" placeholder="Ej: Panadería San Juan" />
                    </div>
                </div>
                <div>
                    <label class="block mb-2 text-gray-700">Descripción</label>
                    <textarea class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-primary-600 focus:ring-2 focus:ring-primary-100 outline-none transition" rows="3" placeholder="Describe tu negocio"></textarea>
                </div>
                <div>
            ...
            <div class="flex justify-end mt-8">
                <button class="btn-premium" type="button">Siguiente</button>
            </div>
        </div>
        <!-- Paso 2: Ubicación -->
        <div id="paso-2" class="hidden">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-primary-600 focus:ring-2 focus:ring-primary-100 outline-none transition" placeholder="Calle, número, referencia" />
                </div>
                ...
                <div>
                    ...
                    <input type="text" class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-primary-600 focus:ring-2 focus:ring-primary-100 outline-none transition" value="Perú" />
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div>
            ...
            <div class="flex justify-between mt-8">
                <button class="btn-premium-outline" type="button">Anterior</button>
                <button class="btn-premium" type="button">Siguiente</button>
            </div>
        </div>
        <!-- Paso 3: Categorías -->
        <div id="paso-3" class="hidden">
            ...
            <div>
                ...
                <select multiple class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-primary-600 focus:ring-2 focus:ring-primary-100 outline-none transition">
        ...
        <div id="paso-4" class="hidden">
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-3 gap-4">
                    <input type="text" class="col-span-1 px-4 py-3 rounded-lg border border-gray-200 focus:border-primary-600 focus:ring-2 focus:ring-primary-100 outline-none transition" placeholder="Nombre" />
                    <input type="text" class="col-span-1 px-4 py-3 rounded-lg border border-gray-200 focus:border-primary-600 focus:ring-2 focus:ring-primary-100 outline-none transition" placeholder="Descripción" />
                    <input type="number" class="col-span-1 px-4 py-3 rounded-lg border border-gray-200 focus:border-primary-600 focus:ring-2 focus:ring-primary-100 outline-none transition" placeholder="Precio" />
                </div>
        ...
        <div id="paso-5" class="hidden">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-primary-600 focus:ring-2 focus:ring-primary-100 outline-none transition" placeholder="Ej: Lunes a viernes 8am - 8pm" />
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div>
