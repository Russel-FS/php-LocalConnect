...
@section('content')
    <!-- Hero Section -->
    <section
        class="min-h-screen bg-gradient-to-br from-primary-50 to-white flex items-center justify-center py-12 sm:py-16 lg:py-20">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1
                class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 sm:mb-8 tracking-tight text-primary-700 leading-tight">
                Conecta con tu <span class="text-secondary-600">comunidad local</span>
            </h1>
            <p
                class="text-lg sm:text-xl md:text-2xl lg:text-3xl font-light text-primary-500 mb-8 sm:mb-12 max-w-4xl mx-auto leading-relaxed">
                ...
                <form action="{{ route('negocios.buscar') }}" method="GET" class="relative">
                    <div class="relative flex items-center">
                        ...
                        <div class="absolute right-2">
                            <button type="submit"
                                class="flex items-center gap-2 bg-primary-800 hover:bg-primary-700 text-white px-6 py-2 sm:py-3 rounded-full font-medium transition-all duration-300 hover:shadow-md">
    ...
    <section id="por-que" class="py-16 sm:py-20 lg:py-24 bg-white">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10">
                <div
                    class="text-center p-8 bg-white/80 backdrop-blur-sm rounded-3xl border border-primary-100/50 shadow-sm hover:shadow-lg transition-all duration-300">
    ...
    <section class="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-primary-50 to-white">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10">
                <div
                    class="text-center p-8 bg-white/80 backdrop-blur-sm rounded-3xl border border-primary-100/50 shadow-sm">
                    <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Avatar"
                        class="w-16 h-16 rounded-full mx-auto mb-6 border-4 border-primary-100">
    ...
    <section id="contacto" class="py-16 sm:py-20 lg:py-24 bg-white">
        <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 sm:mb-8 text-primary-700">¿Tienes un negocio local?
            </h2>
            <p class="text-xl sm:text-2xl text-primary-500 mb-8 sm:mb-12 leading-relaxed">Únete a LocalConnect y haz crecer
                tu presencia digital en tu comunidad.</p>
            <a href="{{ route('negocios.registro') }}"
                class="inline-flex items-center gap-3 px-8 py-4 rounded-full font-semibold bg-primary-600 text-white shadow-lg hover:bg-primary-700 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <x-icons.actions.plus class="w-5 h-5" />
                <span>Registrar mi negocio</span>
