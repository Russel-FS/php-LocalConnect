    ...
    <div class="bg-white rounded-xl border border-primary-200 shadow-sm p-6 " id="categoria-contenedor">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 max-h-[420px] overflow-x-auto custom-scroll scroll-smooth">
            ...
            <label class="categoria-checkbox">
                ...
                <div class="flex items-center p-4 pl-6 border-2 border-primary-200 rounded-lg cursor-pointer transition-colors bg-white shadow-sm">
                    <div class="w-5 h-5 border-2 border-primary-200 rounded mr-4 flex items-center justify-center transition-colors">
