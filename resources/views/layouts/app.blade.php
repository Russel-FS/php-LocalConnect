        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="#" class="bg-primary-600 text-white px-4 py-2 rounded-lg hover:bg-primary-700">Registrarse</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <footer class="bg-gray-900 text-white mt-20">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    <h3 class="text-xl font-bold mb-4">LocalConnect</h3>
            ...
            <div class="mt-8 border-t border-gray-800 pt-8">
                <p class="text-gray-400 text-sm text-center">&copy; {{ date('Y') }} LocalConnect. Todos los derechos reservados.</p>
            </div>
        </div>
    </footer>
</body>
