                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                <div class="flex items-center gap-3">
                                    <div class="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center">
                                        <x-icons.outline.business class="w-4 h-4 text-blue-600" />
                                    </div>
                                    <div>
                                        <span class="font-medium text-gray-900">{{ $negocio->nombre_negocio }}</span>
                                        <div class="text-xs text-gray-500">{{ $negocio->vistas_count }} vistas</div>
                                    </div>
                                </div>
                                <div class="text-right text-xs text-gray-500">
                                    <div>{{ $negocio->me_gusta_count }} me gusta</div>
                                    <div>{{ $negocio->favoritos_count }} favoritos</div>
                                </div>
                            </div>
                        @endforeach
                    </div>
                    ...
                    <tbody>
                        @forelse($ultimasSolicitudes as $negocio)
                            <tr class="border-b last:border-0 hover:bg-primary-50/40 transition-all group">
                                ...
                                <td class="py-3 px-2 text-slate-700 whitespace-nowrap">
