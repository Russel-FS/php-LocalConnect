...
<head>
    ...
    <title>Iniciar Sesión | LocalConnect</title>
...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full space-y-6 glass-effect p-8 rounded-3xl shadow-2xl border border-gray-100">
        <!-- Logo y Título -->
        ...
        <form class="mt-8 space-y-5" action="#" method="POST">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="#" class="text-sm font-medium text-gray-600 hover:text-gray-800 transition-colors duration-200">
        ...
        <div class="text-center">
            <p class="text-sm text-gray-600">
                ...
                <a href="#" class="font-medium text-gray-800 hover:text-gray-900 transition-colors duration-200">
                    Regístrate aquí
                </a>
            </p>
        </div>
